...
var q = (t, e, r, i) => {
	for (
		var n = i > 1 ? void 0 : i ? Vi(e, r) : e, s = t.length - 1, a;
		s >= 0;
		s--
	)
...
$e($, {
	...
	fromRotationTranslationScale: () => dn,
	fromRotationTranslationScaleOrigin: () => pn,
	fromScaling: () => sn,
	fromTranslation: () => nn,
	fromValues: () => Yi,
	fromXRotation: () => on,
	...
	multiply: () => vr,
	multiplyScalar: () => _n,
	multiplyScalarAndAdd: () => Bn,
	ortho: () => yn,
	orthoNO: () => yr,
	orthoZO: () => Rn,
	perspective: () => xn,
	perspectiveFromFieldOfView: () => Mn,
	perspectiveNO: () => Mr,
	perspectiveZO: () => gn,
	rotate: () => Ki,
	rotateX: () => en,
...
function Yi(t, e, r, i, n, s, a, o, h, l, f, c, p, u, x, M) {
	var v = new j(16);
	return (
		(v[0] = t),
		(v[1] = e),
...
function ji(t, e, r, i, n, s, a, o, h, l, f, c, p, u, x, M, v) {
	return (
		(t[0] = e),
		(t[1] = r),
		(t[2] = i),
...
function $i(t, e) {
	...
	return (
		...
		(t[1] = -(i * (p * E - u * v) - c * (n * E - s * v) + M * (n * u - s * p))),
		(t[2] = i * (h * E - l * v) - o * (n * E - s * v) + M * (n * l - s * h)),
		(t[3] = -(i * (h * u - l * p) - o * (n * u - s * p) + c * (n * l - s * h))),
		(t[4] = -(a * (p * E - u * v) - f * (h * E - l * v) + x * (h * u - l * p))),
		(t[5] = r * (p * E - u * v) - f * (n * E - s * v) + x * (n * u - s * p)),
		(t[6] = -(r * (h * E - l * v) - a * (n * E - s * v) + x * (n * l - s * h))),
		(t[7] = r * (h * u - l * p) - a * (n * u - s * p) + f * (n * l - s * h)),
		(t[8] = a * (c * E - u * M) - f * (o * E - l * M) + x * (o * u - l * c)),
		(t[9] = -(r * (c * E - u * M) - f * (i * E - s * M) + x * (i * u - s * c))),
...
function Dr() {
	var t = new j(4);
	return (
		j != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0), (t[3] = 0)),
		t
	);
}
function Dt(t) {
...
function Gt() {
	var t = new j(4);
	return (
		j != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0)),
		(t[3] = 1),
		t
	);
}
...
Number.prototype.__to = function (t) {
	switch (t) {
		case oe:
			return A(this.valueOf(), this.valueOf(), this.valueOf(), this.valueOf());
		case ye:
...
function Ue(t, e, r) {
	...
	return (
		console.warn(`Unsupported vector length '${i.length}'`),
		A.plus(i, i, e)
	);
}
function He(t, e, r) {
	...
	(function (e) {
		...
		var r = Object.prototype.hasOwnProperty,
			...
			u =
				...
				typeof Set.prototype.entries == "function"
					? Set
					: Ni(),
			x = !c && typeof WeakMap == "function" ? WeakMap : Gi(),
			M = new x();
		function v(d, y, R, b) {
			if (se(R)) {
		...
		function E(d, y) {
			function R(b, B) {
				...
				if (!se(B) && !Ci(B)) throw new TypeError();
				Oe(d, y, b, B);
			}
			return R;
		}
		...
		function Di(d, y) {
			...
			return Si(d, R === "default" ? "number" : R);
		}
		function Si(d, y) {
			if (y === "string") {
				var R = d.toString;
...
var Ht = class {
	...
	drawRect(...e) {
		let r,
			...
			s = !1;
		(e[0] instanceof fe
			? ((r = e[0].min), (i = e[0].max), (n = e[1] || I.red), (s = e[2] || !1))
...
var ni = {
	...
	he = class extends Se {
		...
		tryInit(e = !1) {
			...
			let r = this.gl || Ne();
			if (!r)
				return e ? ue("Failed to init shader without a global GL context") : !1;
			((this.gl = r),
				(this.program = Qe(
					r.createProgram(),
...
function qt(t, e) {
	return {
		...
		[_.DEPTH_COMPONENT]: [t.DEPTH_COMPONENT, t.DEPTH_COMPONENT, t.UNSIGNED_INT],
		...
		[_.DEPTH_COMPONENT32F]: [t.DEPTH_COMPONENT32F, t.DEPTH_COMPONENT, t.FLOAT],
	}[e];
}
var de;
(function (t) {
...
var Ye = class extends Se {
		...
		create() {
			...
			(e.texImage2D(e.TEXTURE_2D, 0, r, this.width, this.height, 0, i, n, null),
				(this.created = !0),
...
var lt = class extends Se {
		...
		bindNextTexture(e) {
			return (
				e.bind(this.boundTextures.length),
				this.boundTextures.push(e) - 1
			);
		}
...
var xe = function (t, e, r, i) {
	var n = arguments.length,
		s =
			n < 3 ? e : i === null ? (i = Object.getOwnPropertyDescriptor(e, r)) : i,
		a;
	if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
		s = Reflect.decorate(t, e, r, i);
	else
...
var Te = class {
	...
	static cube(e = g.zero(), r = g.one(), i = L()) {
		...
		let o = a.toMesh();
		return (
			o.vertices.forEach((h) => h.color.fill(1)),
			(o.name = "mesh_cube"),
			o
		);
	}
...
var Kt = class {
	constructor(e, r, i) {
		((this.viewProjectionMatrix = w.identity()),
			...
			(this.blitFramebuffer = [new le(0, 0, this.ctx), new le(0, 0, this.ctx)]),
			L() || this.use(),
			(this.helperAssets = {
...
var rr = class {
	...
	init(e) {
		(this.steps[0] ||
			((this.steps[0] = new ne(e.width, e.height, !1, e.format, e.filterMode)),
			(this.steps[0].wrapMode = ve.Clamp),
			this.steps[0].updateParameters()),
			(this.steps[0].width !== e.width || this.steps[0].height !== e.height) &&
...
var uo = jt({ size: "float", modelMatrix: "mat4" }),
	bt = class extends Be(
		new he(wi, Ei, {
...
var po = yt(new he(je, xi, { blend: [O.One, O.One] })),
	Et = class extends yt(
...
var nr = class {
	constructor(e) {
		...
		this.matrlMist = new po();
		this.matrlMistCompose = new Et();
		this.raindropBuffer = new Ge(uo, 3e3);
	...
	async reloadBackground() {
		...
		if (this.options.backgroundOffsetX || this.options.backgroundOffsetY) {
			let ox = this.options.backgroundOffsetX || 0,
				oy = this.options.backgroundOffsetY || 0,
				sw = e.max.x - e.min.x,
				sh = e.max.y - e.min.y;
			e.min.x = Math.max(
				0,
				Math.min(e.min.x + ox, this.originalBackground.size.x - sw),
			);
			e.max.x = e.min.x + sw;
			e.min.y = Math.max(
				0,
				Math.min(e.min.y + oy, this.originalBackground.size.y - sh),
			);
			e.max.y = e.min.y + sh;
		}
		(this.renderer.blit(
		...
		this.options.mist
			? (this.blurRenderer.init(this.background),
				this.blurRenderer.downSample(
					this.background,
					Math.max(this.options.backgroundBlurSteps, this.options.mistBlurStep),
				),
...
var wt = class {
	...
	set mass(e) {
		...
		let a =
			this.simulator && this.simulator.options
				? this.simulator.options.raindropMaxSize
				: void 0;
		if (a && a > 0) {
			let o = Math.max(this._size.x, this._size.y);
			if (o > a) {
				let h = a / o;
				((this._size.x *= h), (this._size.y *= h));
			}
		}
	}
	get size() {
...
var sr = class {
	...
	get interval() {
		let v = this.simulator.options.spawnInterval;
		return Array.isArray(v) ? v : [v, v];
	}
	get size() {
		let v = this.simulator.options.spawnSize;
		return Array.isArray(v) ? v : [v, v];
	}
	get spawnRect() {
...
var _i = class {
	...
	async start() {
		...
		// 초기 결로만: dropletsPerSeconds가 0이어도 시작 시 한 번만 미세 물방울 채움
		let rate = this.options.dropletsPerSeconds;
		if (rate === 0) {
			this.options.dropletsPerSeconds = 8000;
			this.renderer.options.dropletsPerSeconds = 5000;
		}
		let initDt = 0.05,
			initSteps = 120;
		for (let i = 0; i < initSteps; i++) {
			this.renderer.drawDroplet({ dt: initDt });
			this.renderer.drawMist(initDt);
		}
		if (rate === 0) {
			this.options.dropletsPerSeconds = 0;
			this.renderer.options.dropletsPerSeconds = 0;
		}
		let e = 0,
			r = (i) => {
				let n = (i - e) / 1e3;
